...
Goal:
- Ensure WRK001..WRK400 have login-enabled User accounts
...
async def main():
    async with AsyncSessionLocal() as session:
        ...
        if not target_profiles:
            print("No WRK001..WRK400 worker profiles found.")
            return
        ...
        print("wrk001@railsync.local .. wrk400@railsync.local")
        print()
